...
class HoshiDictsAbiTest {
    ...
    fun typedModelsExposeCompletePitchAndKanjiAbi() {
        ...
        assertConstructor(
            ...
            arrayClass("de.manhhao.hoshi.TraceCandidate"),
        )
        assertConstructor(
            className = "de.manhhao.hoshi.InspectResult",
            Boolean::class.javaPrimitiveType!!,
            String::class.java,
            Boolean::class.javaPrimitiveType!!,
            Boolean::class.javaPrimitiveType!!,
    ...
    fun nativeMethodsExposeKanjiSessionAbi() {
        ...
        val inspectDictionary = bridgeClass.getDeclaredMethod(
            "inspectDictionary",
            String::class.java,
        )
        assertEquals(loadClass("de.manhhao.hoshi.InspectResult"), inspectDictionary.returnType)
    }
